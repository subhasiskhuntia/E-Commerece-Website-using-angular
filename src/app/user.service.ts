...
export class UserService {
  ...
  BuyTheProduct(amount:number){
    ...
    this.http.post("http://localhost:8081/api/user/buyProduct",{"amount":amount}).subscribe(result=>{
      console.log("called ");
      console.log(result);
